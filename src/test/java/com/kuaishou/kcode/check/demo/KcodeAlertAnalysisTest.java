...
public class KcodeAlertAnalysisTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sourceFilePath1 = "D:\\GameData\\kcodeF\\data1\\kcodeAlertForStudent-1.data";
        // ruleForStudent-1，报警规则
        String ruleFilePath1 = "D:\\GameData\\kcodeF\\data1\\ruleForStudent-1.txt";
        // Q1Result-1.txt，第一问结果
        String q1ResultFilePath1 = "D:\\GameData\\kcodeF\\data1\\Q1Result-1.txt";
        // Q2Result-1.txt，第二问输出和结果
        String q2ResultFilePath1 = "D:\\GameData\\kcodeF\\data1\\Q2Result-1.txt";
        // 第二套数据集
        //kcodeAlertForStudent-2.data，原始监控数据
        String sourceFilePath2 = "D:\\GameData\\kcodeF\\data2\\kcodeAlertForStudent-2.data";
        // ruleForStudent-1，报警规则
        String ruleFilePath2 = "D:\\GameData\\kcodeF\\data2\\ruleForStudent-2.txt";
        // Q1Result-1.txt，第一问结果
        String q1ResultFilePath2 = "D:\\GameData\\kcodeF\\data2\\Q1Result-2.txt";
        // Q2Result-1.txt，第二问输出和结果
        String q2ResultFilePath2 = "D:\\GameData\\kcodeF\\data2\\Q2Result-2.txt";

        String sourceFilePath3 = "D:\\GameData\\kcodeF\\KcodeAlertAnalysis-data-test\\test\\kcodeAlertForStudent-test.data";
        // ruleForStudent-1，报警规则
        String ruleFilePath3 = "D:\\GameData\\kcodeF\\KcodeAlertAnalysis-data-test\\test\\ruleForStudent-test.txt";
        // Q1Result-1.txt，第一问结果
        String q1ResultFilePath3 = "D:\\GameData\\kcodeF\\KcodeAlertAnalysis-data-test\\test\\Q1Result-test.data";
        // Q2Result-1.txt，第二问输出和结果
        String q2ResultFilePath3 = "D:\\GameData\\kcodeF\\KcodeAlertAnalysis-data-test\\test\\Q2Answer-test.data";
...
//        testQuestion12(sourceFilePath2, ruleFilePath2, q1ResultFilePath2, q2ResultFilePath2);
    ...
    public static void testQuestion12(String sourceFilePath, String ruleFilePath, String q1ResultFilePath, String q2ResultFilePath) throws Exception {
        ...
        System.out.println("Q1 cast:" + (finish - start)/1000000);
        ...
        if (Objects.isNull(alertResult) || alertResult.size() != q1CheckResult.size()) {
            System.out.println("Q1 Error Size:" + q1CheckResult + "," + q1CheckResult.size());
            System.out.println("Q1 Error Size:" + resultSet + "," + resultSet.size());
            return;
        }
        if (!resultSet.containsAll(q1CheckResult)) {
            System.out.println("Q1 Error Value:" + q1CheckResult + "," + q1CheckResult.size());
            System.out.println("Q1 Error Value:" + resultSet + "," + resultSet.size());
        ...
        for (Map.Entry<Q2Input, Set<Q2Result>> entry : q2Result.entrySet()) {
            ...
            if (Objects.isNull(longestPaths) || longestPaths.size() != checkResult.size()) {
                System.out.println("Q2 Error Size:" + q2Input + "," + checkResult.size());
                System.out.println("Q2 Error Size:" + results + "," + results.size());
            }

            if (!results.containsAll(checkResult)) {
                System.out.println("Q2 Error Result:" + q2Input + "," + checkResult.size());
                System.out.println("Q2 Error Result:" + results + "," + results.size());
            }
            cast += (finish - start);
        }
